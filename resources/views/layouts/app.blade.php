...
<head>
    ...
    <meta name="description" content="Ruang digital resmi Kelas XI RPL 2.">
    <title>@yield('title', 'Kelas XI RPL 2')</title>
    ...
    <style>
        ...
        * {
        ...
        .offcanvas {
            background: linear-gradient(155deg, var(--blue), var(--navy)) !important;
        }
        ...
        /* Seamless hero-to-members transition and footer refinements. */
        .hero {
            position: relative;
            overflow: hidden;
        }
        ...
        #anggota {
            background: linear-gradient(180deg, var(--navy) 0%, #101c31 100%);
        }
        ...
        .org-level:not(.org-root)::after {
            content: "";
            position: absolute;
            top: 0;
            left: calc(50% - 135px);
            width: 270px;
            border-top: 1px solid rgba(201, 166, 107, 0.72);
        }

        .org-level:not(.org-root) .org-card::before {
            content: "";
            position: absolute;
            left: 50%;
            top: -2.25rem;
            height: 2.25rem;
            border-left: 1px solid rgba(201, 166, 107, 0.72);
        }
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('[data-tab]').forEach((button) => button.addEventListener('click', () => {
                ...
                document.querySelectorAll('[data-tab]').forEach((item) => item.classList.toggle(
                    'active', item === button));
                document.querySelectorAll('.tab-panel').forEach((panel) => panel.classList.toggle(
                    'd-none', panel.id !== tab));
